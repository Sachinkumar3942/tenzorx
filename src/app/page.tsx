              ...
              {result ? (
                <div className="bg-white border border-gray-200 rounded-xl shadow-xl p-8 flex flex-col h-full relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                    ...
                    <div className={`px-4 py-1.5 rounded font-bold text-xs tracking-wider uppercase ${
                        result.recommendation === 'approve_tier_2' || result.recommendation.includes('approve')
